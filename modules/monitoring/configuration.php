...
$section->add($this->translate('Devices'), array(
    'url'      => 'monitoring/list/hosts',
    'priority' => 50
));
//$section->add($this->translate('Services'), array(
$section->add($this->translate('Parameters'), array(
    'url'      => 'monitoring/list/services',
    'priority' => 50
));
$section->add($this->translate('Sites'), array(
...
/*
$dashboard = $this->dashboard($this->translate('Tactical OverView'));
$dashboard->add(
